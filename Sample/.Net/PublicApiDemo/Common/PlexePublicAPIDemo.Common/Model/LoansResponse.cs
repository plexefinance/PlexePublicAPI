...
namespace PlexePublicAPIDemo.Common.Model
{
    ...
    public class LoansResponse
    {
        ...
        public List<LoansResponseValue> value { get; set; }
    }
    public class LoansResponseValue
    {
        ...
        public ApplicationCommission LineOfCommission { get; set; }
        public ApplicationCommission SecuredCommission { get; set; }
